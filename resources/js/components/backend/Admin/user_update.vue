            ...
            <div class="card card-small mb-4 pt-3">
                <div class="card-header border-bottom text-center">
                    <div class="mb-3 mx-auto" id="image_id">
                        <img class="rounded-circle" v-if="user_image!=null" :src="user_image" :alt="myLang.image_set" width="110" />
...
export default {
  ...
  methods: {
    //get Table data
    loadUserDetailsData() {
      axios.get("user_details/"+this.user_id)
        .then(({ data }) => {
...
// Details data
            ...
            if (users.image==null) {
                this.user_image=this.BASE_URL + "/storage/app/backend/images/default/no-image.png"
            }else{
                this.user_image=this.BASE_URL+'storage/app/backend/images/user_images/'+users.image
            }
    ...
    //User Update
    updateUser() {
      axios.post("users_update",this.form)
        .then(({ data }) => {
